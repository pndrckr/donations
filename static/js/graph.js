...
function makeGraphs(error, projectsJson, statesJson) {
    ...
    var teacherPrefixDim = ndx.dimension(function (d) {
    ...
    var totalDonationsByTeacherPrefix = teacherPrefixDim.group().reduceSum(function (d) {
        return d["total_donations"];
    });
    ...
    var fundingTeacherPrefixChart = dc.pieChart("#funding-teacher-prefix-chart");
